                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'admin@logsentinel.com') }}" id="username" name="email" placeholder="Masukkan email">
                                        @error('email')
                                    ...
                                    <div class="mb-3">
                                        {{-- <div class="float-end">
                                            <a href="{{ route('password.update') }}" class="text-muted">Lupa password?</a>
                                        </div> --}}
                                        <label class="form-label" for="password-input">Password <span class="text-danger">*</span></label>
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" class="form-control password-input pe-5 @error('password') is-invalid @enderror" name="password" placeholder="Masukkan password" id="password-input" value="password">
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-primary w-100" type="submit">
                                            <i class="ri-shield-keyhole-line me-1"></i> Masuk ke Dashboard
                                        </button>
                                    </div>

                                    {{-- Social Media Login - Disabled --}}

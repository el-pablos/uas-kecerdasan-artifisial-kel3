    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- Web Apps Dropdown - Disabled for Log Sentinel --}}
                ...
                {{-- Cart Dropdown - Disabled for Log Sentinel --}}
                {{-- <div class="dropdown topbar-head-dropdown ms-1 header-item">
                ...
                {{-- Notifications Dropdown - Disabled for Log Sentinel --}}
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ Auth::user()->avatar ? URL::asset('images/' . Auth::user()->avatar) : URL::asset('build/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        {{-- Menu items disabled for Log Sentinel --}}
...
{{-- removeNotificationModal - Disabled for Log Sentinel --}}
